...
from selectinf.Simulation.instance import (poisson_group_instance)
...
def test_comparison_poisson_lasso_vary_s(n=500,
    ...
    oper_char_df = pd.DataFrame.from_dict(oper_char)
    oper_char_df.to_csv('selectinf/randomized/Tests/pois_vary_sparsity0_100.csv', index=False)
...
def test_plotting(path='selectinf/randomized/Tests/pois_vary_sparsity0_100.csv'):
...
def test_plotting_separate(path='selectinf/randomized/Tests/pois_vary_sparsity0_100.csv'):
    oper_char_df = pd.read_csv(path)
