...
def vary_inter(start, end, dir):
    ...
    parameter_list = np.array([0.5, 1, 2, 5])
    pval_dict = {}
    ...
    for inter_sig in parameter_list:
        for i in range(start, end):
            ...
            print(inter_sig, i, "th simulation done")
            print("seed:", i + 1000)
            ...
            if not noselection_naive:
                ...
                oper_char["inter signal"].append(inter_sig)
                ...
                update_targets(dict=target_dict,
                               ...
                               targets=targets, parameter=inter_sig,
            ...
            if not ds_rank_def and not noselection_ds:
                ...
                update_targets(dict=target_dict,
                               true_inter_list=None,
                               targets=targets_ds, parameter=inter_sig,
            ...
            if not noselection_MLE:
                ...
                update_targets(dict=target_dict,
                               true_inter_list=None,
                               targets=targets_MLE, parameter=inter_sig,
            ...
            MSE_dict["inter signal"].append(inter_sig)
            ...
            F1_dict["inter signal"].append(inter_sig)
