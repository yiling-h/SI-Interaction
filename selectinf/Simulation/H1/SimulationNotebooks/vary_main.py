...
def vary_main(start, end, dir):
    ...
    parameter_list = np.array([0.5, 2, 5, 10])
    pval_dict = {}
    ...
    for main_sig in parameter_list:
        for i in range(start, end):
            ...
            MSE_dict["main signal"].append(main_sig)
